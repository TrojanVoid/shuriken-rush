...
namespace Com.ShurikenRush.System.Input
{
    public class InputService : MonoBehaviour
    {
        ...
        {
            return UnityEngine.Input.GetMouseButtonDown(0) || (UnityEngine.Input.touchCount > 0 && UnityEngine.Input.touches[0].phase == TouchPhase.Began);
        }
        private static bool GetPrimary()
        {
            return UnityEngine.Input.GetMouseButton(0) || (UnityEngine.Input.touchCount > 0 && (UnityEngine.Input.touches[0].phase == TouchPhase.Moved || UnityEngine.Input.touches[0].phase == TouchPhase.Stationary));
        }
        private static bool GetPrimaryUp()
        {
            return UnityEngine.Input.GetMouseButtonUp(0) || (UnityEngine.Input.touchCount > 0 && (UnityEngine.Input.touches[0].phase == TouchPhase.Ended || UnityEngine.Input.touches[0].phase == TouchPhase.Canceled));
        }
        private static Vector2 GetPrimaryPosition()
        {
            return UnityEngine.Input.touchCount > 0 ? UnityEngine.Input.touches[0].position : (Vector2)UnityEngine.Input.mousePosition;
        }
